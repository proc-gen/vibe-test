...
- **Key Pattern**: Buffer Geometry. It takes the line segments generated by the Turtle and bundles them into a `THREE.LineSegments` object for efficient GPU rendering.
